...
template <class T>
void ImmediateRenderer<T>::end()
{
}

template <>
void ImmediateRenderer<Quad2Int>::draw(const Quad2Int &quad)
{
...
template <>
void ImmediateRenderer<ColoredQuad2Int>::draw(const ColoredQuad2Int &quad)
{
    // assertCorrectPrimitive(quad.primitiveType);
    for (int i = 0; i < 4; i++) {
...
template <>
void ImmediateRenderer<FontQuad>::draw(const FontQuad &quad)
{
